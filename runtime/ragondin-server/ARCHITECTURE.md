...
- **Thin driver, shared engine (P1).** `ragondin-server` and `ragondin-harness` wrap the
  **same** `ragondin-engine`. There is one execution path; Cargo proves it because
