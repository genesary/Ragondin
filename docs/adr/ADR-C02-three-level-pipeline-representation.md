...
The *what/how* framing quoted above is why the claim looked true, which is why it is preserved rather than merely described: the same framing had already propagated into a doc comment in `ragondin-pipeline` before it was caught.
