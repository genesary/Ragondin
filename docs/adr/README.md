...
- **`ADR-C01-*.md` … `ADR-C19-*.md`** — the frozen decisions of the *code* architecture, one file per decision, cited as `ADR-C1` … `ADR-C19`.
...
- Code-architecture decisions use the `C` prefix: `ADR-C1` … `ADR-C19`.
