...
| `ragondin-experiments` | The run store — `RunId`, `Run`, `FileSystemRunStore` — and the metric-by-metric `compare` behind `ragondin compare`. No export adapter, no registry, no user interface. |
